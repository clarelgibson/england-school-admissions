...
Now let's review the entries for the local authority identifiers and check which rows in `prefs` are not present in `info_la` and therefore need to be changed.
