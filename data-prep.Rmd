...
Finally, let's rename the columns in `info` to suit this analysis better.
...
The matrix below shows the fact and dimension tables that I intend to create for this model and the relationships between them. ![bus-matrix-for-school-admissions-dashboard](images/bus-matrix.png)
